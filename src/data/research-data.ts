...
export const projects: Project[] = [
  ...
  {
    id: "multilingual-family",
    title: "Multilingual Family",
    description: "Exploring how multilingual families navigate home language practices, intergenerational communication, and identity development across everyday contexts.",
    image: multilingualEducation,
    paperCount: 2,
    tagline: "Home language, identity, and belonging",
    papers: [
      {
        id: "family-1",
        title: "Intergenerational Language Brokering in Multilingual Families",
        authors: "Rivera, P., Choi, Y., & Hassan, N.",
        year: 2024,
        journal: "Journal of Family Language Policy",
        keywords: ["language brokering", "intergenerational communication", "multilingual families", "identity"],
        methodology: "Qualitative",
        summary: "Investigates how children and adolescents mediate language and meaning between family members across multilingual households.",
        quote: "In multilingual families, translation is never only about words — it is also about relationships.",
        abstract: "This qualitative study examines how 18 multilingual families negotiate intergenerational communication when children frequently broker language for parents and grandparents. Drawing on home observations, family interviews, and audio diaries, the researchers show that language brokering functions not only as a practical strategy but also as a relational practice shaping responsibility, closeness, and cultural identity. The findings highlight both the emotional labor and the linguistic creativity embedded in everyday family interactions.",
        methodologyDetail: {
          type: "Qualitative",
          participants: "18 multilingual families with children ages 10-17",
          dataCollection: "Home observations, family interviews, youth audio diaries, artifact collection",
          analysis: "Thematic coding, interaction analysis, family narrative analysis",
        },
        findings: [
          "Youth language brokers often acted as cultural interpreters in addition to translating vocabulary.",
          "Families described language brokering as strengthening trust, but also creating stress when children mediated high-stakes situations.",
          "Grandparents' participation increased when families intentionally created multilingual routines at home.",
          "Identity talk frequently emerged during brokering moments, especially around respect, belonging, and family responsibility.",
        ],
        implications: [
          "Schools and community organizations should recognize language brokering as a family literacy practice rather than a deficit.",
          "Support resources for multilingual families should address the emotional dimensions of youth mediation work.",
          "This research extends multilingual education conversations into family and community language ecologies.",
        ],
      },
      {
        id: "family-2",
        title: "Weekend Heritage Schools and Family Language Maintenance",
        authors: "Lee, H., Martínez, S., & Dubois, C.",
        year: 2023,
        journal: "International Journal of Multilingualism",
        keywords: ["heritage language", "family literacy", "weekend schools", "language maintenance"],
        methodology: "Mixed Methods",
        summary: "Examines how weekend heritage language schools interact with home practices to sustain multilingual development.",
        quote: "Languages survive in families when learning is shared across classrooms, kitchens, and communities.",
        abstract: "Using a mixed-methods design, this study analyzes the experiences of 126 families enrolled in weekend heritage language schools across three metropolitan areas. Survey data, parent focus groups, and student literacy samples reveal that successful language maintenance depends on alignment between school routines, home practices, and children's sense of ownership over the heritage language. The study identifies family-level strategies that make multilingual maintenance more sustainable over time.",
        methodologyDetail: {
          type: "Mixed Methods",
          participants: "126 families, 9 weekend school coordinators, and 74 children ages 7-14",
          dataCollection: "Parent surveys, focus groups, student writing samples, school document review",
          analysis: "Descriptive statistics, comparative case analysis, qualitative content analysis",
        },
        findings: [
          "Families who combined weekend schooling with regular home literacy routines reported the strongest language maintenance outcomes.",
          "Children's motivation increased when they saw the heritage language linked to friendships and community participation.",
          "Parents valued weekend schools most when teachers shared practical ideas for continuing language use at home.",
          "Scheduling pressure and uneven parental confidence were the most common barriers to sustained participation.",
        ],
        implications: [
          "Heritage language programs should design family-facing resources, not only child-facing curriculum.",
          "Community-based multilingual education works best when home and school expectations are mutually reinforcing.",
          "This project offers a family-centered perspective that complements classroom-focused multilingual education research.",
        ],
      },
    ],
  },
